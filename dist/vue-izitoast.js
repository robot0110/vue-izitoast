...
(function webpackUniversalModuleDefinition(root, factory) {
	if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["vue-izitoast"] = factory();else root["vue-izitoast"] = factory();
		...
		/***/function (module, __webpack_exports__, __webpack_require__) {
			...
			function plugin(Vue, options) {
				...
				var toasts = new Vue({
					...
					_checkParams: function _checkParams(message, title, options) {
					...
					_checkEventNames: function _checkEventNames(eventName) {
					...
					methods: {
						show: function show(message) {
							...
							this.$options._izi.show(Object.assign({}, options, { message: message, title: title }));
						},
						hide: function hide() {
							var toast = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
						...
						progress: function progress(toast) {
							var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
						...
						info: function info(message) {
							...
							this.$options._checkParams(message, title, options);
							this.$options._izi.info(Object.assign({}, options, { message: message, title: title }));
						},
						success: function success(message) {
							...
							this.$options._checkParams(message, title, options);
							this.$options._izi.success(Object.assign({}, options, { message: message, title: title }));
						},
						warning: function warning(message) {
							...
							this.$options._checkParams(message, title, options);
							this.$options._izi.warning(Object.assign({}, options, { message: message, title: title }));
						},
						error: function error(message) {
							...
							this.$options._checkParams(message, title, options);
							this.$options._izi.error(Object.assign({}, options, { message: message, title: title }));
						},
						question: function question(message) {
							...
							this.$options._checkParams(message, title, options);
							this.$options._izi.question(Object.assign({}, options, { message: message, title: title }));
						},
